export const answers = [
    ...
    {
        q: "Kurš no kabeļu tipiem var sastāvēt no divām dzīslām, no kuriem katrs var pārraidīt datus tikai vienā virzienā?",
        a: "Optiskais"
    },
    {
    ...
    {
        q: "Kura no tīkla topoloģijām vislabāk raksturo tīklu Internet?	",
        a: "WAN"
    },
    {
    ...
    {
        q: "Kura komanda ļauj noskaidrot visas www.dic.lv domēna vārda IP adreses?",
        a: "nslookup www.dic.lv"
    },
    {
        q: "Kāds datu pārraides ātrums ir 100 BASE-T4 Ethernet tīklam?",
        a: "100 MB/s"
    },
    {
        q: "Kurš protokols ļauj iegūt dažāda veida informāciju no IP iekārtām?",
        a: "SNMP"
    },
    {
        q: "Kurš saīsinājums atšifrējas - tīkla faila sistēma?",
        a: "NFS"
    },
    {
        q: "Kāda ir vārtejas (gateway) funkcionālā nozīme?",
        a: "Nodrošināt datu pārraidi starp datoru tīkliem, kuriem ir atšķirīga arhitektūra un/vai protokoli"
    },
    {
    ...
    },
    {
        ...
        a: "Unikāls identifikācijas numurs, kuru kartē iebūvē ražotājs"
    },
    {
    ...
    {
        q: "Kas ir trojāns?",
        a: "Programma, kas izveidota ar mērķi iegūt pieeju lietotāja datoram vai datiem, lietotājam pašam par to nezinot"
    },
    {
        q: "Kam ir nepieciešami cookies?",
        a: "Lai atstātu nelielu informācijas apjomu lapas apmeklētāja pārlūkprogrammā"
    },
    {
    ...
    },
    {
        ...
        a: "Darbības izpildes metode, kura ir pieņemta pēc savstarpējas saskaņošanas"
    },
    {
        q: "Kas ir SMTP, FTP, HTTP, POP3?",
        a: "Dažādi interneta protokoli"
    },
    {
    ...
    {
        q: "Kurš transporta slāņa protokols ir paredzēts kvalitatīva savienojuma izveidošanai atbilstoši OSI modelim?",
        a: "TCP"
    },
    {
